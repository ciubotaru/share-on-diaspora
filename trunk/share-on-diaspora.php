...
<div id=\"diaspora-button-box\" style=\"box-sizing: content-box; -moz-box-sizing: content-box; float:left; margin-right: 10px; height:" . $bs . "px; background-color: #" . $bb . "; -moz-border-radius:" . $br . "px; border-radius:" . $br . "px; border-color: #" . $bc . "; border-width: 1px; color: #" . $bc . "; border-style: solid; padding: 0 0 0 5px; text-align: center; font-size: ". $fs . "px; font-style: normal; font-weight: normal; line-height: 100%;\" onMouseOver=\"this.style.backgroundColor='#" . $bb_h . "'; this.style.color='#" . $bc_h . "'; this.style.borderColor='#" . $bc_h . "'\" onMouseOut=\"this.style.backgroundColor='#" . $bb . "'; this.style.color='#" . $bc . "' ; this.style.borderColor='#" . $bc . "'; overflow: auto;\"><font style=\"font-family:arial,helvetica,sans-serif;font-size:" . $fs ."px;margin: 0; line-height:" . ($bs-2) . "px;\">" . $bt  . "</font> <div id=\"diaspora-button-inner\" style=\"float: right; margin: 1px 1px 1px 5px;height:" . ($bs-3) . "px; background-color: #" . $bb . ";\"><img style=\"vertical-align: top; margin:0 auto; padding:0; border:0;\" src=\"" . plugin_dir_url(__FILE__) . "/images/asterisk-" . ($bs-3) . ".png\"></div>
</div></a>";
    return $button_box;
    }
